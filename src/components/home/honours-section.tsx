    ...
    <section id="honours" className="mx-auto max-w-7xl px-5 py-20 sm:px-8 sm:py-28">
      <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-16">
        ...
        {achievements.length > 0 ? (
          ...
          <div className="flex items-center rounded-lg border border-dashed border-border p-10 text-sm text-fg-faint">
            Our first honours are still ahead of us. Check back after the next
            competition.
          </div>
        )}
      </div>
