...
export const siteSettings = pgTable("site_settings", {
  ...
  // Editable copy. Blank means "fall back to COPY_DEFAULTS in lib/site-copy".
  ...
  capDesign: text("cap_design").notNull().default(""),
  capFabrication: text("cap_fabrication").notNull().default(""),
  capProgramming: text("cap_programming").notNull().default(""),
  capStrategy: text("cap_strategy").notNull().default(""),
  honoursNote: text("honours_note").notNull().default(""),
  honoursEmpty: text("honours_empty").notNull().default(""),
  fleetEmpty: text("fleet_empty").notNull().default(""),
  galleryEmpty: text("gallery_empty").notNull().default(""),
  updatesEmpty: text("updates_empty").notNull().default(""),
  sponsorsIntro: text("sponsors_intro").notNull().default(""),
  sponsorsEmpty: text("sponsors_empty").notNull().default(""),
  footerAbout: text("footer_about").notNull().default(""),
  footerContactNote: text("footer_contact_note").notNull().default(""),
  notFoundBody: text("not_found_body").notNull().default(""),
